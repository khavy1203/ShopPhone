    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="#">
                ...
                <div class="sidebar-brand-text mx-3">Khả Vy <sup>^^</sup></div>
            </a>
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="{{ URL::to('/add-category-product') }}">Thêm danh mục sản
                            phẩm</a>
                        <a class="collapse-item" href="{{ URL::to('/all-category-product') }}">Liệt kê danh mục sản
                            phẩm</a>
                    </div>
                </div>
                ...
                <div id="product" class="collapse" aria-labelledby="headingproduct" data-parent="#product">
                    <div class="bg-white py-2 collapse-inner rounded">
                ...
                <div id="order" class="collapse" aria-labelledby="headingTwo"
                    data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="{{ URL::to('/order-admin') }}">Quản lý đơn hàng</a>
                    </div>
                </div>
            </li>
